...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csharp-mode one-themes atom-one-dark-theme js2-mode vscode-dark-plus-theme gruvbox-theme badwolf-theme material-theme docker-tramp ac-php auto-complete emmet-mode web-mode php-mode)))
